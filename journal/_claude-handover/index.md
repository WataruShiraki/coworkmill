...
> **最終更新**: 2026-05-13（事業戦略ロードマップ追加・オウンドメディア化対応）  
...
| ドキュメント | 内容 | 参照タイミング |
|---|---|---|
| **business-roadmap.md** | 事業戦略・マネタイズ7レイヤー・施設収集マスターリスト・帰宅後タスクリスト | 事業相談・施設収集・Phase A/B/C実行時 |
| **index.md**（このファイル） | ジャーナル記事執筆の引き継ぎ・スタイル要件・対応ルール | ジャーナル記事執筆時 |

→ 事業戦略・データ収集・Stripe・認証フロー・AIレコメンド機能に関する話は、 まず **business-roadmap.md** を参照してください。 ジャーナル記事を書くときはこの index.md を参照してください。
