(function() {
  ...
  s.onload = function() {
    ...
    newBtn.addEventListener('click', async function(e) {
      ...
      overlay.innerHTML = `
        <div style="background:#111;border:1px solid #2a2a2a;border-radius:16px;padding:48px 40px;text-align:center;max-width:400px;margin:20px;">
          <div style="font-size:48px;margin-bottom:20px;">✓</div>
          <h2 style="color:#fff;font-size:20px;margin-bottom:12px;font-family:sans-serif;">お申し込みを受け付けました</h2>
          <p style="color:#888;font-size:13px;line-height:1.8;margin-bottom:28px;font-family:sans-serif;">2〜3営業日以内に審査結果を<br>メールにてお知らせします。</p>
